...
interface AppState {
  ...
  createOrder: (projectId: string, amount: number, items: CartItem[], buyerEmail?: string, buyerPhone?: string, buyerName?: string, returnUrl?: string) => Promise<any>;
...
export const useStore = create<AppState>((set, get) => ({
  ...
  createOrder: async (projectId: string, amount: number, items: CartItem[], buyerEmail?: string, buyerPhone?: string, buyerName?: string, returnUrl?: string) => {
    try {
