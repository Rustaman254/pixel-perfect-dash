...
import { Loader2, Send, Bot, User, X, MessageSquare, CreditCard, CheckCircle, AlertCircle, Clock } from "lucide-react";
          ...
          {messages.length === 0 && (
            <div className="text-center text-slate-500 py-4">
              ...
              <p className="text-xs text-slate-400 mt-1">
                Ask me anything - "show my payments", "create a link", etc.
              </p>
            </div>
          )}
